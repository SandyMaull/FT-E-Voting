            ...
            <div class="row">
                ...
                <div class="col col-lg-6 col-sm-12">
                    ...
                    <div class="form-group" style="display: inline-block">
                        ...
                        <input type="file" class="form-control-file form-control-sm" name="siakadfoto" data-role="file" id="SiakadFoto" placeholder="Foto Siakad" aria-describedby="SiakadFoto_Help" accept="image/x-png,image/jpeg">
